...
async def function1():
    ...
    open("C:/Users/hp/Desktop/img1.ico", "wb").write(response.content)
...
async def function2():
    ...
    response = requests.get(URL)
    open("C:/Users/hp/Desktop/img2.jpg", "wb").write(response.content)
...
async def function3():
    ...
    response = requests.get(URL)
    open("C:/Users/hp/Desktop/img3.ico", "wb").write(response.content)
